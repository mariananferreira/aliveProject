...
import mari3 from '@/images/fotoRS.jpg'
                ...
                <div className="py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12">
                  ...
                  <div className="sm:col-span-2 sm:flex sm:center-end contactAlign">
                    <ul role="list" className="mt-10 flex space-x-6">
                      <li>
                        <a
                          className="websiteColor hover:text-indigo-100"
                    ...
                    <div className="mobileCollumn">
                      <p className="summmaryTextNoSpace marginAdjust">Ou via telefónica:                  
                      </p>              
                    
                      <ul  className="mt-10 mobileIcon">
                        <li>
                            <span className="sr-only ">call
                            </span>
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-phone-call">
